...
- Learn adaptive Gemma MTP speed from actual committed tokens and elapsed time, including both seed cost and seed output. Refresh the ordinary-decode baseline across request cohorts and keep first-use compilation out of steady estimates without hiding its measured cost.
